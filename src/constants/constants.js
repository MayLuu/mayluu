export const projects = [
  {
    ...
    tags: ["Next.js", "Flutter", "Websocket", "SQL", "FPT AI"],

    source:
      "https://audiory-dashboard.vercel.app",
    visit: null,
    id: 22,
  },
  {
  ...
  {
    title: "Mercedes Haxaco Showcase",
    description:
      "A freelance project is developed owing to the needs of showing new cars and grab more potential guests coming to the showroom.",
    image:
  ...
  //   description:
  //     "Design for role admin for an university which can manage students, classes and scores.",
  //   image:
